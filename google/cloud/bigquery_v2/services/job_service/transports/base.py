...
class JobServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.insert_job: gapic_v1.method.wrap_method(
                self.insert_job,
                default_retry=retries.Retry(
                    initial=0.4,
                    maximum=60.0,
            ...
            self.get_query_results: gapic_v1.method.wrap_method(
    ...
    def cancel_job(
        ...
        Union[job.JobCancelResponse, Awaitable[job.JobCancelResponse]],
    ]:
        raise NotImplementedError()
    ...
    def insert_job(
        self,
    ) -> Callable[[job.InsertJobRequest], Union[job.Job, Awaitable[job.Job]]]:
        raise NotImplementedError()
    ...
    def delete_job(
        ...
        [job.DeleteJobRequest], Union[empty_pb2.Empty, Awaitable[empty_pb2.Empty]]
    ]:
        raise NotImplementedError()
    ...
    def list_jobs(
        self,
    ) -> Callable[[job.ListJobsRequest], Union[job.JobList, Awaitable[job.JobList]]]:
        raise NotImplementedError()
    ...
    def get_query_results(
        ...
        Union[job.GetQueryResultsResponse, Awaitable[job.GetQueryResultsResponse]],
    ]:
        raise NotImplementedError()
    ...
    def query(
        ...
        [job.PostQueryRequest], Union[job.QueryResponse, Awaitable[job.QueryResponse]]
    ]:
        raise NotImplementedError()
