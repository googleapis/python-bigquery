...
class ModelServiceClient(metaclass=ModelServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.bigquery_v2.ModelServiceClient`.",
                    extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_model():
                ...
                request = bigquery_v2.GetModelRequest(
        ...
        flattened_params = [project_id, dataset_id, model_id]
    ...
    def list_models(
        ...
        *,
        project_id: Optional[str] = None,
        dataset_id: Optional[str] = None,
        max_results: Optional[wrappers_pb2.UInt32Value] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        Returns:
            google.cloud.bigquery_v2.services.model_service.pagers.ListModelsPager:
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project_id, dataset_id, max_results]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
    ...
    def patch_model(
        self,
        request: Optional[Union[gcb_model.PatchModelRequest, dict]] = None,
        *,
        project_id: Optional[str] = None,
        dataset_id: Optional[str] = None,
        model_id: Optional[str] = None,
        model: Optional[gcb_model.Model] = None,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> gcb_model.Model:
        ...
        # - Quick check: If we got a request object, we should *not* have
        #   gotten any keyword arguments that map to the request.
        flattened_params = [project_id, dataset_id, model_id, model]
        has_flattened_params = (
            len([param for param in flattened_params if param is not None]) > 0
        )
        if request is not None and has_flattened_params:
