...
class ListModelsPager:
    ...
    :class:`google.cloud.bigquery_v2.types.ListModelsResponse` object, and
    ...
    All the usual :class:`google.cloud.bigquery_v2.types.ListModelsResponse`
    ...
    def __init__(
        ...
        *,
        ...
        Args:
            ...
            response (google.cloud.bigquery_v2.types.ListModelsResponse):
