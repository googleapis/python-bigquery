...
class DatasetServiceClient(metaclass=DatasetServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.bigquery_v2.DatasetServiceClient`.",
                    extra={
        ...
        *,
        ...
        .. code-block:: python
            ...
            def sample_get_dataset():
                # Create a client
                client = bigquery_v2.DatasetServiceClient()
        ...
        Args:
            request (Union[google.cloud.bigquery_v2.types.GetDatasetRequest, dict]):
        ...
        Returns:
            google.cloud.bigquery_v2.types.Dataset:
    ...
    def insert_dataset(
        self,
        request: Optional[Union[dataset.InsertDatasetRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        .. code-block:: python
            ...
            def sample_insert_dataset():
                # Create a client
                client = bigquery_v2.DatasetServiceClient()

                # Initialize request argument(s)
                dataset = bigquery_v2.Dataset()
                dataset.dataset_reference.dataset_id = "dataset_id_value"

                request = bigquery_v2.InsertDatasetRequest(
                    project_id="project_id_value",
                    dataset=dataset,
                )

                # Make the request
                response = client.insert_dataset(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.bigquery_v2.types.InsertDatasetRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, dataset.InsertDatasetRequest):
            request = dataset.InsertDatasetRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.insert_dataset]
    ...
    def patch_dataset(
        self,
        request: Optional[Union[dataset.UpdateOrPatchDatasetRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> dataset.Dataset:
        r"""Updates information in an existing dataset. The
        update method replaces the entire dataset resource,
        whereas the patch method only replaces fields that are
        provided in the submitted dataset resource.
        ...
        .. code-block:: python
            ...
            def sample_patch_dataset():
                ...
                request = bigquery_v2.UpdateOrPatchDatasetRequest(
                    project_id="project_id_value",
                    dataset_id="dataset_id_value",
                    dataset=dataset,
                )
                ...
                # Make the request
                response = client.patch_dataset(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.bigquery_v2.types.UpdateOrPatchDatasetRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, dataset.UpdateOrPatchDatasetRequest):
            request = dataset.UpdateOrPatchDatasetRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.patch_dataset]
    ...
    def delete_dataset(
        ...
        *,
        ...
        r"""Deletes the dataset specified by the datasetId value.
        Before you can delete a dataset, you must delete all its
        tables, either manually or by specifying deleteContents.
        ...
        .. code-block:: python
            ...
            def sample_delete_dataset():
                ...
                # Initialize request argument(s)
                request = bigquery_v2.DeleteDatasetRequest(
                    project_id="project_id_value",
                    dataset_id="dataset_id_value",
                )
        ...
        Args:
            request (Union[google.cloud.bigquery_v2.types.DeleteDatasetRequest, dict]):
    ...
    def list_datasets(
        ...
        *,
        ...
        r"""Lists all datasets in the specified project to which
        the user has been granted the READER dataset role.
        ...
        .. code-block:: python
            ...
            def sample_list_datasets():
                ...
                # Initialize request argument(s)
                request = bigquery_v2.ListDatasetsRequest(
                    project_id="project_id_value",
                )
        ...
        Args:
            request (Union[google.cloud.bigquery_v2.types.ListDatasetsRequest, dict]):
                The request object.
            retry (google.api_core.retry.Retry): Designation of what errors, if any,
                should be retried.
            timeout (float): The timeout for this request.
        ...
        Returns:
            google.cloud.bigquery_v2.services.dataset_service.pagers.ListDatasetsPager:
    ...
    def undelete_dataset(
        self,
        request: Optional[Union[dataset.UndeleteDatasetRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> dataset.Dataset:
        r"""Undeletes a dataset which is within time travel
        window based on datasetId. If a time is specified, the
        dataset version deleted at that time is undeleted, else
        the last live version is undeleted.
        ...
        .. code-block:: python
            ...
            def sample_undelete_dataset():
                # Create a client
                client = bigquery_v2.DatasetServiceClient()

                # Initialize request argument(s)
                request = bigquery_v2.UndeleteDatasetRequest(
                    project_id="project_id_value",
                    dataset_id="dataset_id_value",
                )

                # Make the request
                response = client.undelete_dataset(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.bigquery_v2.types.UndeleteDatasetRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, dataset.UndeleteDatasetRequest):
            request = dataset.UndeleteDatasetRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.undelete_dataset]
