    ...
    * Stripping extraneous information from responses
    ...
    .. code-block:: python
        class MyCustomModelServiceInterceptor(ModelServiceRestInterceptor):
            ...
            def pre_patch_model(self, request, metadata):
                logging.log(f"Received request: {request}")
                return request, metadata

            def post_patch_model(self, response):
                logging.log(f"Received response: {response}")
                return response
    ...
    def pre_patch_model(
        ...
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[gcb_model.PatchModelRequest, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Pre-rpc interceptor for patch_model
    ...
    def post_patch_model(self, response: gcb_model.Model) -> gcb_model.Model:
        """Post-rpc interceptor for patch_model

        DEPRECATED. Please use the `post_patch_model_with_metadata`
        interceptor instead.

        Override in a subclass to read or manipulate the response
        after it is returned by the ModelService server but before
        it is returned to user code. This `post_patch_model` interceptor runs
        before the `post_patch_model_with_metadata` interceptor.
        """
        return response

    def post_patch_model_with_metadata(
        self,
        response: gcb_model.Model,
        metadata: Sequence[Tuple[str, Union[str, bytes]]],
    ) -> Tuple[gcb_model.Model, Sequence[Tuple[str, Union[str, bytes]]]]:
        """Post-rpc interceptor for patch_model

        Override in a subclass to read or manipulate the response or metadata after it
        is returned by the ModelService server but before it is returned to user code.

        We recommend only using this `post_patch_model_with_metadata`
        interceptor in new development instead of the `post_patch_model` interceptor.
        When both interceptors are used, this `post_patch_model_with_metadata` interceptor runs after the
        `post_patch_model` interceptor. The (possibly modified) response returned by
        `post_patch_model` will be passed to
        `post_patch_model_with_metadata`.
        """
        return response, metadata
...
class ModelServiceRestTransport(_BaseModelServiceRestTransport):
    ...
    class _DeleteModel(
        ...
        def __call__(
            ...
            *,
            ...
            Args:
                request (~.model.DeleteModelRequest):
                    The request object. Request format for deleting BigQuery
                ML models.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.bigquery_v2.ModelServiceClient.DeleteModel",
                    extra={
        ...
        def __call__(
            ...
            *,
            ...
            Args:
                ...
                information about a BigQuery ML model.
                retry (google.api_core.retry.Retry): Designation of what errors, if any,
                    should be retried.
                timeout (float): The timeout for this request.
                metadata (Sequence[Tuple[str, Union[str, bytes]]]): Key/value pairs which should be
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.bigquery_v2.ModelServiceClient.GetModel",
                    extra={
                        "serviceName": "google.cloud.bigquery.v2.ModelService",
                        "rpcName": "GetModel",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.bigquery_v2.ModelServiceClient.get_model",
                    extra={
                        "serviceName": "google.cloud.bigquery.v2.ModelService",
                        "rpcName": "GetModel",
    ...
    class _ListModels(
        ...
        def __call__(
            ...
            *,
            ...
            Args:
                request (~.model.ListModelsRequest):
                    The request object. Request format for listing BigQuery
                ML models.
                retry (google.api_core.retry.Retry): Designation of what errors, if any,
                    should be retried.
                timeout (float): The timeout for this request.
            ...
            Returns:
                ~.model.ListModelsResponse:
                    Response format for a single page
                when listing BigQuery ML models.
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.bigquery_v2.ModelServiceClient.ListModels",
                    extra={
                        "serviceName": "google.cloud.bigquery.v2.ModelService",
                        "rpcName": "ListModels",
                        "httpRequest": http_request,
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.bigquery_v2.ModelServiceClient.list_models",
                    extra={
                        "serviceName": "google.cloud.bigquery.v2.ModelService",
                        "rpcName": "ListModels",
                        "metadata": http_response["headers"],
    ...
    class _PatchModel(
        _BaseModelServiceRestTransport._BasePatchModel, ModelServiceRestStub
    ):
        def __hash__(self):
            return hash("ModelServiceRestTransport.PatchModel")
        ...
        def __call__(
            ...
            *,
            ...
            r"""Call the patch model method over HTTP.
            ...
            http_options = (
                _BaseModelServiceRestTransport._BasePatchModel._get_http_options()
            )

            request, metadata = self._interceptor.pre_patch_model(request, metadata)
            transcoded_request = (
                _BaseModelServiceRestTransport._BasePatchModel._get_transcoded_request(
                    http_options, request
                )
            )

            body = (
                _BaseModelServiceRestTransport._BasePatchModel._get_request_body_json(
                    transcoded_request
                )
            )
            ...
            # Jsonify the query params
            query_params = (
                _BaseModelServiceRestTransport._BasePatchModel._get_query_params_json(
                    transcoded_request
                )
            )
            ...
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    f"Sending request for google.cloud.bigquery_v2.ModelServiceClient.PatchModel",
                    extra={
                        "serviceName": "google.cloud.bigquery.v2.ModelService",
                        "rpcName": "PatchModel",
                        "httpRequest": http_request,
            ...
            # Send the request
            response = ModelServiceRestTransport._PatchModel._get_response(
                self._host,
                metadata,
                query_params,
                self._session,
            ...
            # Return the response
            resp = gcb_model.Model()
            pb_resp = gcb_model.Model.pb(resp)

            json_format.Parse(response.content, pb_resp, ignore_unknown_fields=True)

            resp = self._interceptor.post_patch_model(resp)
            response_metadata = [(k, str(v)) for k, v in response.headers.items()]
            resp, _ = self._interceptor.post_patch_model_with_metadata(
                resp, response_metadata
            )
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                logging.DEBUG
                ...
                try:
                    response_payload = gcb_model.Model.to_json(response)
                except:
                    response_payload = None
                http_response = {
                    "payload": response_payload,
                ...
                _LOGGER.debug(
                    "Received response for google.cloud.bigquery_v2.ModelServiceClient.patch_model",
                    extra={
                        "serviceName": "google.cloud.bigquery.v2.ModelService",
                        "rpcName": "PatchModel",
                        "metadata": http_response["headers"],
    ...
    @property
    def delete_model(self) -> Callable[[model.DeleteModelRequest], empty_pb2.Empty]:
    ...
    @property
    def patch_model(self) -> Callable[[gcb_model.PatchModelRequest], gcb_model.Model]:
        # The return type is fine, but mypy isn't sophisticated enough to determine what's going on here.
        # In C++ this would require a dynamic_cast
        return self._PatchModel(self._session, self._host, self._interceptor)  # type: ignore
