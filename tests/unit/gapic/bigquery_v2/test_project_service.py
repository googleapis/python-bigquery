...
from google.cloud.bigquery_v2.services.project_service import ProjectServiceClient
from google.cloud.bigquery_v2.services.project_service import transports
...
def test_project_service_client_get_transport_class():
    ...
    assert transport == transports.ProjectServiceRestTransport
...
@pytest.mark.parametrize("client_class", [ProjectServiceClient])
@mock.patch.object(
    ProjectServiceClient,
    "DEFAULT_ENDPOINT",
...
def test_get_service_account_rest_use_cached_wrapped_rpc():
...
def test_get_service_account_rest_required_fields(
    request_type=project.GetServiceAccountRequest,
):
    ...
    unset_fields = transport_class(
        credentials=ga_credentials.AnonymousCredentials()
    ).get_service_account._get_unset_required_fields(jsonified_request)
    ...
    return_value = project.GetServiceAccountResponse()
    ...
    with mock.patch.object(Session, "request") as req:
        ...
        with mock.patch.object(path_template, "transcode") as transcode:
            ...
            return_value = project.GetServiceAccountResponse.pb(return_value)
...
def test_get_service_account_rest_unset_required_fields():
    transport = transports.ProjectServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials
    )

    unset_fields = transport.get_service_account._get_unset_required_fields({})
...
def test_get_service_account_rest_bad_request(
    request_type=project.GetServiceAccountRequest,
):
    client = ProjectServiceClient(
...
@pytest.mark.parametrize(
    "request_type",
    [
        project.GetServiceAccountRequest,
        dict,
    ],
)
def test_get_service_account_rest_call_success(request_type):
    client = ProjectServiceClient(
        credentials=ga_credentials.AnonymousCredentials(), transport="rest"
    )
    ...
    assert isinstance(response, project.GetServiceAccountResponse)
    assert response.kind == "kind_value"
    assert response.email == "email_value"


@pytest.mark.parametrize("null_interceptor", [True, False])
def test_get_service_account_rest_interceptors(null_interceptor):
    transport = transports.ProjectServiceRestTransport(
        credentials=ga_credentials.AnonymousCredentials(),
        interceptor=None
        if null_interceptor
    ...
    with mock.patch.object(
        ...
        transports.ProjectServiceRestInterceptor, "post_get_service_account"
    ) as post, mock.patch.object(
        transports.ProjectServiceRestInterceptor,
        "post_get_service_account_with_metadata",
    ) as post_with_metadata, mock.patch.object(
        transports.ProjectServiceRestInterceptor, "pre_get_service_account"
    ) as pre:
        pre.assert_not_called()
        post.assert_not_called()
        post_with_metadata.assert_not_called()
        pb_message = project.GetServiceAccountRequest.pb(
            project.GetServiceAccountRequest()
        )
        ...
        req.return_value.headers = {"header-1": "value-1", "header-2": "value-2"}
        return_value = project.GetServiceAccountResponse.to_json(
        ...
        post.return_value = project.GetServiceAccountResponse()
        post_with_metadata.return_value = project.GetServiceAccountResponse(), metadata
...
def test_get_service_account_empty_call_rest():
    client = ProjectServiceClient(
        credentials=ga_credentials.AnonymousCredentials(),
        transport="rest",
    )
    ...
    with mock.patch.object(
        ...
        request_msg = project.GetServiceAccountRequest()
...
def test_project_service_base_transport():
    ...
    with mock.patch(
        "google.cloud.bigquery_v2.services.project_service.transports.ProjectServiceTransport.__init__"
    ) as Transport:
...
def test_project_service_base_transport_with_credentials_file():
    ...
    with mock.patch.object(
        ...
        "google.cloud.bigquery_v2.services.project_service.transports.ProjectServiceTransport._prep_wrapped_messages"
    ) as Transport:
        Transport.return_value = None
...
def test_project_service_client_transport_session_collision(transport_name):
    ...
    session1 = client1.transport.get_service_account._session
    session2 = client2.transport.get_service_account._session
...
@pytest.mark.parametrize(
    ...
    [
        (ProjectServiceClient, transports.ProjectServiceRestTransport),
    ],
)
