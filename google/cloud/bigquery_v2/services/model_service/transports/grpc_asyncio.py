...
class ModelServiceGrpcAsyncIOTransport(ModelServiceTransport):
    ...
    @property
    def get_model(self) -> Callable[[model.GetModelRequest], Awaitable[model.Model]]:
    ...
    def list_models(
        self,
    ) -> Callable[[model.ListModelsRequest], Awaitable[model.ListModelsResponse]]:
    ...
    def patch_model(
        self,
    ) -> Callable[[gcb_model.PatchModelRequest], Awaitable[gcb_model.Model]]:
    ...
    def delete_model(
        self,
    ) -> Callable[[model.DeleteModelRequest], Awaitable[empty.Empty]]:
