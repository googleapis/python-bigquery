...
class JobServiceClient(metaclass=JobServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.bigquery_v2.JobServiceClient`.",
                    extra={
    ...
    def cancel_job(
        self,
        request: Optional[Union[job.CancelJobRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> job.JobCancelResponse:
        r"""Requests that a job be cancelled. This call will
        return immediately, and the client will need to poll for
        the job status to see if the cancel completed
        ...
        .. code-block:: python
            ...
            def sample_cancel_job():
                # Create a client
                client = bigquery_v2.JobServiceClient()

                # Initialize request argument(s)
                request = bigquery_v2.CancelJobRequest(
        ...
        Args:
            request (Union[google.cloud.bigquery_v2.types.CancelJobRequest, dict]):
        ...
        Returns:
            google.cloud.bigquery_v2.types.JobCancelResponse:
        ...
        if not isinstance(request, job.CancelJobRequest):
            request = job.CancelJobRequest(request)
    ...
    def get_job(
        ...
        *,
        ...
        r"""Returns information about a specific job. Job
        information is available for a six month period after
        creation. Requires that you're the person who ran the
        ...
        .. code-block:: python
            ...
            def sample_get_job():
                ...
                # Initialize request argument(s)
                request = bigquery_v2.GetJobRequest(
                    project_id="project_id_value",
                    job_id="job_id_value",
                )
        ...
        Args:
            request (Union[google.cloud.bigquery_v2.types.GetJobRequest, dict]):
        ...
        Returns:
            google.cloud.bigquery_v2.types.Job:
    ...
    def insert_job(
        self,
        request: Optional[Union[job.InsertJobRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> job.Job:
        r"""Starts a new asynchronous job.

        This API has two different kinds of endpoint URIs, as this
        method supports a variety of use cases.

        -  The *Metadata* URI is used for most interactions, as it
           accepts the job configuration directly.
        -  The *Upload* URI is ONLY for the case when you're sending
           both a load job configuration and a data stream together. In
           this case, the Upload URI accepts the job configuration and
        ...
        .. code-block:: python
            ...
            def sample_insert_job():
                # Create a client
                client = bigquery_v2.JobServiceClient()

                # Initialize request argument(s)
                request = bigquery_v2.InsertJobRequest(
                )

                # Make the request
                response = client.insert_job(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.bigquery_v2.types.InsertJobRequest, dict]):
        ...
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, job.InsertJobRequest):
            request = job.InsertJobRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.insert_job]
    ...
    def delete_job(
        ...
        *,
        ...
        r"""Requests the deletion of the metadata of a job. This
        call returns when the job's metadata is deleted.
        ...
        .. code-block:: python
            ...
            def sample_delete_job():
                ...
                # Initialize request argument(s)
                request = bigquery_v2.DeleteJobRequest(
                    project_id="project_id_value",
                    job_id="job_id_value",
                )
        ...
        Args:
            request (Union[google.cloud.bigquery_v2.types.DeleteJobRequest, dict]):
    ...
    def list_jobs(
        ...
        *,
        ...
        r"""Lists all jobs that you started in the specified
        project. Job information is available for a six month
        period after creation. The job list is sorted in reverse
        chronological order, by job creation time. Requires the
        Can View project role, or the Is Owner project role if
        you set the allUsers property.
        ...
        .. code-block:: python
            ...
            def sample_list_jobs():
                ...
                # Initialize request argument(s)
                request = bigquery_v2.ListJobsRequest(
                    project_id="project_id_value",
                )
        ...
        Args:
            request (Union[google.cloud.bigquery_v2.types.ListJobsRequest, dict]):
        ...
        Returns:
            google.cloud.bigquery_v2.services.job_service.pagers.ListJobsPager:
    ...
    def get_query_results(
        self,
        request: Optional[Union[job.GetQueryResultsRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
        ...
        .. code-block:: python
            ...
            def sample_get_query_results():
                # Create a client
                client = bigquery_v2.JobServiceClient()

                # Initialize request argument(s)
                request = bigquery_v2.GetQueryResultsRequest(
                    project_id="project_id_value",
                    job_id="job_id_value",
                )

                # Make the request
                response = client.get_query_results(request=request)

                # Handle the response
                print(response)

        Args:
            request (Union[google.cloud.bigquery_v2.types.GetQueryResultsRequest, dict]):
        ...
        Returns:
            google.cloud.bigquery_v2.types.GetQueryResultsResponse:
                Response object of GetQueryResults.
        """
        # Create or coerce a protobuf request object.
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, job.GetQueryResultsRequest):
            request = job.GetQueryResultsRequest(request)

        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_query_results]
    ...
    def query(
        self,
        request: Optional[Union[job.PostQueryRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> job.QueryResponse:
        r"""Runs a BigQuery SQL query synchronously and returns
        query results if the query completes within a specified
        timeout.
        ...
        .. code-block:: python
            ...
            def sample_query():
                ...
                # Initialize request argument(s)
                query_request = bigquery_v2.QueryRequest()
                query_request.query = "query_value"

                request = bigquery_v2.PostQueryRequest(
                    project_id="project_id_value",
        ...
        Args:
            request (Union[google.cloud.bigquery_v2.types.PostQueryRequest, dict]):
        ...
        Returns:
            google.cloud.bigquery_v2.types.QueryResponse:

        """
        # Create or coerce a protobuf request object.
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, job.PostQueryRequest):
            request = job.PostQueryRequest(request)
