...
class TestRowIterator(unittest.TestCase):
    ...
    def test__validate_bqstorage_returns_false_w_warning_if_obsolete_version(self):
        ...
        patcher = mock.patch(
            "google.cloud.bigquery.table._versions_helpers.BQ_STORAGE_VERSIONS.verify_version",
    ...
    def test_to_arrow_ensure_bqstorage_client_wo_bqstorage(self):
        ...
        with mock.patch(
            "google.cloud.bigquery._versions_helpers.BQ_STORAGE_VERSIONS.verify_version",
            mock_verify_version,
        ):
