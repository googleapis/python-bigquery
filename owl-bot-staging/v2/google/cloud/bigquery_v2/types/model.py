...
class Model(proto.Message):
    ...
    class BinaryClassificationMetrics(proto.Message):
        ...
        aggregate_classification_metrics: 'Model.AggregateClassificationMetrics' = proto.Field(
            proto.MESSAGE,
            number=1,
            message='Model.AggregateClassificationMetrics',
        )
        binary_confusion_matrix_list: MutableSequence['Model.BinaryClassificationMetrics.BinaryConfusionMatrix'] = proto.RepeatedField(
            proto.MESSAGE,
            number=2,
    ...
    class MultiClassClassificationMetrics(proto.Message):
        ...
        class ConfusionMatrix(proto.Message):
            ...
            class Row(proto.Message):
                ...
                entries: MutableSequence['Model.MultiClassClassificationMetrics.ConfusionMatrix.Entry'] = proto.RepeatedField(
                    proto.MESSAGE,
                    number=2,
            ...
            rows: MutableSequence['Model.MultiClassClassificationMetrics.ConfusionMatrix.Row'] = proto.RepeatedField(
                proto.MESSAGE,
                number=2,
        ...
        confusion_matrix_list: MutableSequence['Model.MultiClassClassificationMetrics.ConfusionMatrix'] = proto.RepeatedField(
            proto.MESSAGE,
            number=2,
    ...
    class ClusteringMetrics(proto.Message):
        ...
        class Cluster(proto.Message):
            ...
            class FeatureValue(proto.Message):
                ...
                class CategoricalValue(proto.Message):
                    ...
                    category_counts: MutableSequence['Model.ClusteringMetrics.Cluster.FeatureValue.CategoricalValue.CategoryCount'] = proto.RepeatedField(
                        proto.MESSAGE,
                        number=1,
            ...
            feature_values: MutableSequence['Model.ClusteringMetrics.Cluster.FeatureValue'] = proto.RepeatedField(
                proto.MESSAGE,
                number=2,
        ...
        clusters: MutableSequence['Model.ClusteringMetrics.Cluster'] = proto.RepeatedField(
            proto.MESSAGE,
            number=3,
    ...
    class ArimaForecastingMetrics(proto.Message):
        ...
        Attributes:
            non_seasonal_order (MutableSequence[google.cloud.bigquery_v2.types.Model.ArimaOrder]):
                Non-seasonal order.
            arima_fitting_metrics (MutableSequence[google.cloud.bigquery_v2.types.Model.ArimaFittingMetrics]):
        ...
        class ArimaSingleModelForecastingMetrics(proto.Message):
            ...
            seasonal_periods: MutableSequence['Model.SeasonalPeriod.SeasonalPeriodType'] = proto.RepeatedField(
                proto.ENUM,
                number=5,
        ...
        non_seasonal_order: MutableSequence['Model.ArimaOrder'] = proto.RepeatedField(
            proto.MESSAGE,
            number=1,
            message='Model.ArimaOrder',
        )
        arima_fitting_metrics: MutableSequence['Model.ArimaFittingMetrics'] = proto.RepeatedField(
            proto.MESSAGE,
            number=2,
            message='Model.ArimaFittingMetrics',
        )
        ...
        has_drift: MutableSequence[bool] = proto.RepeatedField(
            proto.BOOL,
            number=4,
        )
        time_series_id: MutableSequence[str] = proto.RepeatedField(
            proto.STRING,
            number=5,
        )
        arima_single_model_forecasting_metrics: MutableSequence['Model.ArimaForecastingMetrics.ArimaSingleModelForecastingMetrics'] = proto.RepeatedField(
            proto.MESSAGE,
            number=6,
    ...
    class EvaluationMetrics(proto.Message):
        ...
        binary_classification_metrics: 'Model.BinaryClassificationMetrics' = proto.Field(
            proto.MESSAGE,
            number=2,
            oneof='metrics',
            message='Model.BinaryClassificationMetrics',
        )
        multi_class_classification_metrics: 'Model.MultiClassClassificationMetrics' = proto.Field(
            proto.MESSAGE,
            number=3,
            oneof='metrics',
    ...
    class ArimaFittingMetrics(proto.Message):
        ...
        log_likelihood: float = proto.Field(
            proto.DOUBLE,
            number=1,
        )
        aic: float = proto.Field(
            proto.DOUBLE,
            number=2,
        )
    ...
    class GlobalExplanation(proto.Message):
        ...
        explanations: MutableSequence['Model.GlobalExplanation.Explanation'] = proto.RepeatedField(
            proto.MESSAGE,
            number=1,
    ...
    class TrainingRun(proto.Message):
        ...
        Attributes:
            ...
            global_explanations (MutableSequence[google.cloud.bigquery_v2.types.Model.GlobalExplanation]):
        ...
        class TrainingOptions(proto.Message):
            ...
            include_drift: bool = proto.Field(
                proto.BOOL,
                number=41,
            )
            ...
            preserve_input_structs: bool = proto.Field(
                proto.BOOL,
                number=45,
            )
        ...
        class IterationResult(proto.Message):
            ...
            class ArimaResult(proto.Message):
                ...
                class ArimaCoefficients(proto.Message):
                    ...
                    auto_regressive_coefficients: MutableSequence[float] = proto.RepeatedField(
                        proto.DOUBLE,
                        number=1,
                    )
                    moving_average_coefficients: MutableSequence[float] = proto.RepeatedField(
                        proto.DOUBLE,
                        number=2,
                    )
                    intercept_coefficient: float = proto.Field(
                        proto.DOUBLE,
                        number=3,
                    )
                ...
                arima_model_info: MutableSequence['Model.TrainingRun.IterationResult.ArimaResult.ArimaModelInfo'] = proto.RepeatedField(
                    proto.MESSAGE,
                    number=1,
            ...
            cluster_infos: MutableSequence['Model.TrainingRun.IterationResult.ClusterInfo'] = proto.RepeatedField(
                proto.MESSAGE,
                number=8,
        ...
        results: MutableSequence['Model.TrainingRun.IterationResult'] = proto.RepeatedField(
            proto.MESSAGE,
            number=6,
        ...
        global_explanations: MutableSequence['Model.GlobalExplanation'] = proto.RepeatedField(
            proto.MESSAGE,
            number=10,
    ...
    feature_columns: MutableSequence[standard_sql.StandardSqlField] = proto.RepeatedField(
        proto.MESSAGE,
        number=10,
