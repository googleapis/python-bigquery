...
class DatasetServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            ...
            self.insert_dataset: gapic_v1.method.wrap_method(
                self.insert_dataset,
                default_retry=retries.Retry(
                    initial=0.1,
                    maximum=60.0,
            ...
            self.patch_dataset: gapic_v1.method.wrap_method(
                self.patch_dataset,
                default_retry=retries.Retry(
                    initial=0.1,
                    maximum=60.0,
            ...
            self.undelete_dataset: gapic_v1.method.wrap_method(
                self.undelete_dataset,
                default_retry=retries.Retry(
                    initial=0.4,
                    maximum=60.0,
                    multiplier=2.0,
    ...
    def list_datasets(
        ...
        Union[dataset.DatasetList, Awaitable[dataset.DatasetList]],
    ]:
        raise NotImplementedError()
