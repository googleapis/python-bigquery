...
class ModelServiceTransport(abc.ABC):
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.get_model: gapic_v1.method.wrap_method(
                self.get_model, default_timeout=600.0, client_info=client_info,
            ),
            self.list_models: gapic_v1.method.wrap_method(
                self.list_models, default_timeout=600.0, client_info=client_info,
            ),
            self.patch_model: gapic_v1.method.wrap_method(
                self.patch_model, default_timeout=600.0, client_info=client_info,
            ),
            self.delete_model: gapic_v1.method.wrap_method(
                self.delete_model, default_timeout=600.0, client_info=client_info,
            ),
        }
    ...
    def list_models(
        ...
        typing.Union[
            model.ListModelsResponse, typing.Awaitable[model.ListModelsResponse]
        ],
    ]:
        raise NotImplementedError()
    ...
    def patch_model(
        ...
        typing.Union[gcb_model.Model, typing.Awaitable[gcb_model.Model]],
    ]:
        raise NotImplementedError()
