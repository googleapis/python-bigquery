...
class RowAccessPolicyServiceTransport(abc.ABC):
    """Abstract transport class for RowAccessPolicyService."""
    ...
    def _prep_wrapped_messages(self, client_info):
        ...
        self._wrapped_methods = {
            self.list_row_access_policies: gapic_v1.method.wrap_method(
                self.list_row_access_policies,
            ...
            self.get_row_access_policy: gapic_v1.method.wrap_method(
                self.get_row_access_policy,
                default_retry=retries.Retry(
                    initial=0.1,
                    maximum=60.0,
                    multiplier=1.3,
            ...
            self.create_row_access_policy: gapic_v1.method.wrap_method(
            ...
            self.update_row_access_policy: gapic_v1.method.wrap_method(
                self.update_row_access_policy,
                default_retry=retries.Retry(
                    initial=0.1,
                    maximum=60.0,
                    multiplier=1.3,
            ...
            self.delete_row_access_policy: gapic_v1.method.wrap_method(
                self.delete_row_access_policy,
                default_retry=retries.Retry(
                    initial=0.1,
                    maximum=60.0,
                    multiplier=1.3,
            ...
            self.batch_delete_row_access_policies: gapic_v1.method.wrap_method(
                self.batch_delete_row_access_policies,
                default_retry=retries.Retry(
                    initial=0.1,
                    maximum=60.0,
                    multiplier=1.3,
    ...
    def list_row_access_policies(
        ...
        Union[
            ...
            Awaitable[row_access_policy.ListRowAccessPoliciesResponse],
        ],
    ]:
        raise NotImplementedError()
    ...
    def get_row_access_policy(
        ...
        Union[
            ...
            Awaitable[row_access_policy.RowAccessPolicy],
        ],
    ]:
        raise NotImplementedError()
...
__all__ = ("RowAccessPolicyServiceTransport",)
