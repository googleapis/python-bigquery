...
class ModelServiceAsyncClient:
    ...
    async def get_model(
        ...
        *,
        ...
        Args:
            request (:class:`~.model.GetModelRequest`):
                The request object.
        ...
        if request is not None and any([project_id, dataset_id, model_id]):
            raise ValueError(
    ...
    async def list_models(
        ...
        *,
        ...
        Args:
            request (:class:`~.model.ListModelsRequest`):
                The request object.
            project_id (:class:`str`):
            ...
            dataset_id (:class:`str`):
                ...
                on the ``request`` instance; if ``request`` is provided, this
                should not be set.
            max_results (:class:`~.wrappers.UInt32Value`):
        ...
        # Sanity check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        if request is not None and any([project_id, dataset_id, max_results]):
            raise ValueError(
                "If the `request` argument is set, then none of "
                "the individual field arguments should be set."
            )
    ...
    async def patch_model(
        ...
        *,
        ...
        Args:
            request (:class:`~.gcb_model.PatchModelRequest`):
                The request object.
            project_id (:class:`str`):
        ...
        # Sanity check: If we got a request object, we should *not* have
        # gotten any keyword arguments that map to the request.
        if request is not None and any([project_id, dataset_id, model_id, model]):
            raise ValueError(
                "If the `request` argument is set, then none of "
                "the individual field arguments should be set."
            )
    ...
    async def delete_model(
        ...
        *,
        ...
        Args:
            request (:class:`~.model.DeleteModelRequest`):
                The request object.
            project_id (:class:`str`):
                Required. Project ID of the model to
                delete.
...
try:
    DEFAULT_CLIENT_INFO = gapic_v1.client_info.ClientInfo(
        gapic_version=pkg_resources.get_distribution("google-cloud-bigquery",).version,
    )
