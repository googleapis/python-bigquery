...
class ProjectServiceClient(metaclass=ProjectServiceClientMeta):
        ...
        *,
        ...
        if "async" not in str(self._transport):
            if CLIENT_LOGGING_SUPPORTED and _LOGGER.isEnabledFor(
                ...
                _LOGGER.debug(
                    "Created client `google.cloud.bigquery_v2.ProjectServiceClient`.",
                    extra={
    ...
    def get_service_account(
        self,
        request: Optional[Union[project.GetServiceAccountRequest, dict]] = None,
        *,
        retry: OptionalRetry = gapic_v1.method.DEFAULT,
        timeout: Union[float, object] = gapic_v1.method.DEFAULT,
        metadata: Sequence[Tuple[str, Union[str, bytes]]] = (),
    ) -> project.GetServiceAccountResponse:
        r"""RPC to get the service account for a project used for
        ...
        .. code-block:: python
            ...
            def sample_get_service_account():
                # Create a client
                client = bigquery_v2.ProjectServiceClient()

                # Initialize request argument(s)
                request = bigquery_v2.GetServiceAccountRequest(
        ...
        Args:
            request (Union[google.cloud.bigquery_v2.types.GetServiceAccountRequest, dict]):
        ...
        Returns:
            google.cloud.bigquery_v2.types.GetServiceAccountResponse:
                Response object of GetServiceAccount
        """
        # Create or coerce a protobuf request object.
        # - Use the request object if provided (there's no risk of modifying the input as
        #   there are no flattened fields), or create one.
        if not isinstance(request, project.GetServiceAccountRequest):
            request = project.GetServiceAccountRequest(request)
