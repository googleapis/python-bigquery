...
def test_bq_to_arrow_data_type_w_struct(module_under_test, bq_type):
    ...
    expected = (
        ...
        pyarrow.field("field07", _helpers.pyarrow_numeric()),
        pyarrow.field("field08", _helpers.pyarrow_bignumeric()),
        pyarrow.field("field09", pyarrow.bool_()),
        pyarrow.field("field10", pyarrow.bool_()),
        pyarrow.field("field11", _helpers.pyarrow_timestamp()),
        pyarrow.field("field12", pyarrow.date32()),
        pyarrow.field("field13", _helpers.pyarrow_time()),
        pyarrow.field("field14", _helpers.pyarrow_datetime()),
